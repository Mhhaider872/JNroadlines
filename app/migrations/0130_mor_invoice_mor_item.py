...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0129_remove_mor_item_invoice_delete_mor_invoice_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unloadcharge', models.CharField(blank=True, max_length=300, null=True)),
                ('unloadrate', models.FloatField(blank=True, default=0, null=True)),
                ('g_amount', models.FloatField(blank=True, default=0, null=True)),
                ('sacD', models.IntegerField(blank=True, null=True)),
                ('Fo_dateD', models.DateField(blank=True, null=True)),
                ('To_dateD', models.DateField(blank=True, null=True)),
                ('d_rateD', models.IntegerField(blank=True, null=True)),
                ('par_dayD', models.IntegerField(blank=True, null=True)),
                ('totalD', models.IntegerField(blank=True, null=True)),
                ('charges_D', models.CharField(blank=True, max_length=300, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='MOR_Item',
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.mor_invoice')),
            ],
        ),
    ]
