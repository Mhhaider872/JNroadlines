# Generated by Django 5.1.6 on 2025-05-22 09:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0255_alter_ainvoice_lr_no_alter_ginvoice_lr_no_and_more'),
    ]

    operations = [
        migrations.CreateModel(
            name='Aak_out_Invoice',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.aak_out_invoice')),
            ],
        ),
    ]
