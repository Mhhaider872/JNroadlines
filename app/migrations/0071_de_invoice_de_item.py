...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0070_remove_hwitem_invoice_delete_hwinvoice_delete_hwitem'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.de_invoice')),
            ],
        ),
    ]
