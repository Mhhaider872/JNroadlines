...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0045_rename_tool_name_usetool_tool'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='usetool',
            name='tool',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.tools'),
        ),
        migrations.CreateModel(
            name='CRItem',
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.crinvoice')),
            ],
        ),
    ]
