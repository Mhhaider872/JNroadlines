...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0048_remove_crinvoice_fo_date_remove_crinvoice_to_date'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.ve_invoice')),
            ],
        ),
    ]
