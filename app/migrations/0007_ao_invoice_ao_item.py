...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0006_remove_vc_item_dispatch_date_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.ao_invoice')),
            ],
        ),
    ]
