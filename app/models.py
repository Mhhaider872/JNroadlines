...
class AddTrips(models.Model):
    ...
    dolr_num=models.CharField(max_length=200, null=True, blank=True)
    lr_date=models.DateField(null=True, blank=True)
    dolr_date=models.DateField(null=True, blank=True)
    freight_bill=models.CharField(max_length=200, null=True, blank=True)
    dofreight_bill=models.CharField(max_length=200, null=True, blank=True)
    freight_date=models.DateField(null=True, blank=True)
    dofreight_date=models.DateField(null=True, blank=True)
...
class DriverL(models.Model):
    ...
    load=models.IntegerField(null=True, blank=True)
    unload=models.IntegerField(null=True, blank=True)
    short_kg=models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    previous_loan = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True )
...
#========================ADANI KAKINADA BILLING SYSTEM==========================
class AKInvioce(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class AKItem(models.Model):
    invoice = models.ForeignKey(AKInvioce, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#========================ADANI MUNDRA BILLING SYSTEM==========================
class ADMInvioce(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
    ...
    # Fo_date=models.DateField(null=True, blank=True)
    # To_date=models.DateField(null=True, blank=True)
    d_rate=models.DecimalField(max_digits=10, decimal_places=2, default=0, null=True, blank=True)
    par_day=models.IntegerField(null=True, blank=True)
    total_d=models.IntegerField(null=True, blank=True) 
    cgst = models.FloatField(default=0.0,null=True, blank=True)
    sgst = models.FloatField(default=0.0,null=True, blank=True)
...
class ADMItem(models.Model):
    invoice = models.ForeignKey(ADMInvioce, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
class ASL_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
    ...
    g_total = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    grand_total = models.FloatField(default=0.0,null=True, blank=True)
    unloadcharge=models.CharField(max_length=300, null=True, blank=True)
    unloadrate= models.FloatField(default=0,null=True, blank=True)
    g_amount= models.FloatField(default=0,null=True, blank=True)
    tmsid=models.IntegerField(null=True, blank=True)
...
class ASL_Item(models.Model):
    invoice = models.ForeignKey(ASL_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
class CRInvoice(models.Model):
    ...
    From_add=models.CharField(max_length=200, null=True, blank=True)
    To_add=models.CharField(max_length=200,null=True, blank=True)
    date_dis=models.DateTimeField(null=True, blank=True)
    # load=models.IntegerField(null=True, blank=True)
    # rate_kg=models.IntegerField(null=True, blank=True)
    unload=models.IntegerField(null=True, blank=True)
    short=models.IntegerField(null=True, blank=True)
...
class CRItem(models.Model):
    invoice = models.ForeignKey(CRInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================AAK INDIA RAIPUR BILLING SYSTEM ==================================
class AAKR_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class AAKR_Item(models.Model):
    invoice = models.ForeignKey(AAKR_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
class SAItem(models.Model):
    invoice = models.ForeignKey(SAInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================RION REFOIL BILLING SYSTEM ==================================
class RRInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class RRItem(models.Model):
    invoice = models.ForeignKey(RRInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================NHT COMPANY BILLING SYSTEM ==================================
class NHTInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class NHTItem(models.Model):
    invoice = models.ForeignKey(NHTInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================MURLIWALA BILLING SYSTEM ==================================
class MUInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class MUItem(models.Model):
    invoice = models.ForeignKey(MUInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================MALANI BILLING SYSTEM ==================================
class MAInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class MAItem(models.Model):
    invoice = models.ForeignKey(MAInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================PATEL TRADERS BILLING SYSTEM ==================================
class PT_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class PT_Item(models.Model):
    invoice = models.ForeignKey(PT_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================KOP Agro BILLING SYSTEM ==================================
class KOP_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class KOP_Item(models.Model):
    invoice = models.ForeignKey(KOP_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================HABHIT WELLNESS SYSTEM ==================================
class HInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class HItem(models.Model):
    invoice = models.ForeignKey(HInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================DHANLAXMI BILLING SYSTEM ==================================
class DE_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class DE_Item(models.Model):
    invoice = models.ForeignKey(DE_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
class BC_Item(models.Model):
    invoice = models.ForeignKey(BC_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================CARGILL DAVANGER BILLING SYSTEM ==================================
class CD_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class CD_Item(models.Model):
    invoice = models.ForeignKey(CD_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================CARGILL BHIMASAR BILLING SYSTEM ==================================
class CB_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class CB_Item(models.Model):
    invoice = models.ForeignKey(CB_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================CARGILL KURKUMBH BILLING SYSTEM ==================================
class CK_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class CK_Item(models.Model):
    invoice = models.ForeignKey(CK_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================BUNGE INDIA PVT LTD SYSTEM ==================================
class BU_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class BU_Item(models.Model):
    invoice = models.ForeignKey(BU_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================AKM INTERNATIONAL BILLING SYSTEM ==================================
class AKM_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class AKM_Item(models.Model):
    invoice = models.ForeignKey(AKM_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================ANJANI AGRO BILLING SYSTEM ==================================
class ANGInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class ANGItem(models.Model):
    invoice = models.ForeignKey(ANGInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================SIDDHIVINAYAK DATA  BILLING SYSTEM ==================================
class SVDInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class SVDItem(models.Model):
    invoice = models.ForeignKey(SVDInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================VISWAAT CHEMICAL LTD BILLING SYSTEM ==================================
class VCLInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class VCLItem(models.Model):
    invoice = models.ForeignKey(VCLInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
class GRNItem(models.Model):
    invoice = models.ForeignKey(GRNInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================VVF INDIA (BADDI )MULTILINE BILLING SYSTEM ==================================
...
#=======================VVF INDIA (TALOJA)MULTILINE BILLING SYSTEM ==================================

#=======================VERTEX SALES MULTILINE BILLING SYSTEM ==================================
class VERTEXInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class VERTEXItem(models.Model):
    invoice = models.ForeignKey(VERTEXInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================ALLANA MULTILINE BILLING SYSTEM ==================================
class ALLANAInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class ALLANAItem(models.Model):
    invoice = models.ForeignKey(ALLANAInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#=======================MORDE FOODS  BILLING SYSTEM ==================================
class MOR_Invoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
    ...
    sacD=models.IntegerField(null=True, blank=True)
    Fo_dateD=models.DateField(null=True, blank=True)
    To_dateD=models.DateField(null=True, blank=True)
    d_rateD=models.IntegerField(null=True, blank=True)
    par_dayD=models.IntegerField(null=True, blank=True)
    totalD=models.IntegerField(null=True, blank=True) 
    charges_D=models.CharField(max_length=300, null=True, blank=True)
...
class MOR_Item(models.Model):
    invoice = models.ForeignKey(MOR_Invoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=3)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
...
#==========================AAK INDIA (LOCAL ) SYSTEM ==================================
class AAKRMInvoice(models.Model):
    invoice_number = models.CharField(max_length=100)
    date=models.DateField(null=True, blank=True)
    company=models.CharField(max_length=300, null=True, blank=True)
    gst=models.CharField(max_length=300, null=True, blank=True)
...
class AAKRMItem(models.Model):
    invoice = models.ForeignKey(AAKRMInvoice, related_name='items', on_delete=models.CASCADE)
    description = models.CharField(max_length=255)
    quantity = models.IntegerField(default=1)
    unit_price = models.DecimalField(max_digits=10, decimal_places=2)
    total_price = models.DecimalField(max_digits=10, decimal_places=2)
    
    tanker_no=models.CharField(max_length=200, null=True, blank=True)
    date=models.DateField(null=True, blank=True)
    From_add=models.CharField(max_length=200, null=True, blank=True)
    To_add=models.CharField(max_length=200,null=True, blank=True)
    lrno=models.CharField(max_length=200, null=True, blank=True)
    totalkm=models.IntegerField(null=True, blank=True)
    diesel=models.IntegerField(null=True, blank=True)
    dieselrate = models.DecimalField(max_digits=10, decimal_places=2)
    dieselamount = models.DecimalField(max_digits=10, decimal_places=2)
    urearate = models.DecimalField(max_digits=10, decimal_places=2)
    ureaamount= models.DecimalField(max_digits=10, decimal_places=2)
